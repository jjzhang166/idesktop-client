...
#ifdef Q_WS_WIN
    QImage normalRight = QImage(":images/handle_right.png");
    QImage normalLeft = QImage(":images/handle_left.png");
#endif
#ifdef Q_WS_X11
    QImage normalRight = QImage(":images/handle_right_linux.png");
    QImage normalLeft = QImage(":images/handle_left_linux.png");
#endif
...
void TopWidget::enterEvent(QEvent *event)
{
    qDebug() << "enter";
    if (_direction == LEFT)
        _pixmap = _normalLeft;
...
void TopWidget::leaveEvent(QEvent *event)
{
    qDebug() << "leave";
    if (_direction == LEFT)
        _pixmap = _transLeft;
