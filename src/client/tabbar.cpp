	...
	, _animateSwitch(true)
{
	...
	addTab(QIcon(":images/recommended.png"), tr("精品推荐"));
	addTab(QIcon(":images/warehouse.png"), tr("软件仓库"));
	addTab(QIcon(":images/updates.png"), tr("升级软件"));
	addTab(QIcon(":images/uninstall"), tr("卸载软件"));
