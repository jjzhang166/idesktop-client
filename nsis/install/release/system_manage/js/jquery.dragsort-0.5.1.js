		...
		this.each(function(i, cont) {
			...
			var newList = {
				...
				dropItem: function() {
					...
					if (list.draggedItem.attr("data-origpos") != $(lists).index(list) + "-" + list.getItems().index(list.draggedItem)||list.draggedItem.attr("data-origpos") != $(lists).index(list) + "--" + list.getItems().index(list.draggedItem))
